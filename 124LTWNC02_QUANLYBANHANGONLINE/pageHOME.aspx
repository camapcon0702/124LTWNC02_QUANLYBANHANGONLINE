<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageHOME.aspx.cs" Inherits="_124LTWNC02_QUANLYBANHANGONLINE.pageHOME" %>
          ...
          <select>
              ...
              <option>Euro</option>
                ...
                <div class="left_content">
                    ...
                    <ul class="left_menu">
                        <asp:Repeater ID="Repeater_DANHMUC" runat="server">
                            <ItemTemplate>
                ...
                <div class="right_content">
                    <div class="shopping_cart">
                        ...
                        <div class="cart_icon">
                            <a href="pageGIOHANG.aspx" title="header=[Checkout] body=[&nbsp;] fade=[on]">
